...
import {
  ...
  ChevronDown, Cpu, CreditCard, Lock, MapPin, Zap,
} from "lucide-react";
...
type DashboardSubTab = 'inventory' | 'saved' | 'ads' | 'admin' | 'my-shop' | 'playstore-audit';
                    ...
                    <div className="bg-slate-950 border border-slate-800 rounded-2xl p-4 relative overflow-hidden">
                      ...
                      <div className="max-w-xl">
                        <span className="text-amber-500 text-xs font-extrabold tracking-widest uppercase block mb-1">
                          {language === "bn" ? "বিজ্ঞাপন বুস্ট করুন" : "BOOST YOUR AD"}
                        </span>
                        <h4 className="text-lg font-black text-white font-sans tracking-tight">
                          {language === "bn" ? "আপনার পোস্ট বেশি মানুষ দেখুক" : "Get your post seen by more people"}
                        </h4>
                        <p className="text-slate-400 text-xs mt-1.5 leading-relaxed">
                          {language === "bn"
                            ? "টাকা দিয়ে আপনার পোস্ট বুস্ট করুন। তাহলে সেটা মার্কেটে সবার উপরে এবং হোমপেজের স্লাইডারে দেখাবে।"
                            : "Pay to boost your post — it will show at the top of the market and on the homepage slider."}
                        </p>
                      </div>
                    </div>
